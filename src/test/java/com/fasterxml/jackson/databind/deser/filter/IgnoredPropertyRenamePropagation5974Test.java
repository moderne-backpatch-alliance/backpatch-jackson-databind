 ...
 */
public class IgnoredPropertyRenamePropagation5974Test extends DatabindTestUtil
{
    ...
    public void testRenamedIgnoredPropertyIsStillIgnored() throws Exception
    {
        ...
        assertNull(result.internalRole, "@JsonIgnore must survive the naming-strategy rename");
    }
